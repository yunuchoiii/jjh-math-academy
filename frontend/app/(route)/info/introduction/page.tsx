...
const IntroductionPage = () => {
  ...
  return <div>
    ...
    <section className="mb-20 flex flex-col md:flex-row gap-[30px]">
      <div className="min-w-[300px] min-h-[400px] bg-blue-1 rounded-[20px] shadow-2">
      </div>
      <div className="flex-1 flex flex-col justify-between py-2.5">
        <p className="text-lg leading-relaxed mb-2.5">

...
const improvedGradesList = [
  {
    ...
    description: <div>
      여름방학에 찾아온 중1<br/>
      <span className="highlight">9개월만에 1학기 복습 + 현행 + 선행</span> 끝내고<br/>
      <b>2학년 첫 중간고사 100점!</b>
    </div>,
  },
  {
    ...
    description: <div>
      학원 안 다녀 기초 없던 중1<br/>
      <span className="highlight">6개월만에 1년치 총복습 + 현행</span>하고<br/>
      <b>2학년 첫 중간고사 100점!</b>
    </div>,
  },
  {
    ...
    description: <div>
      초등과정 하나도 모르던 중1<br/>
      <span className="highlight">기본부터 시작해 응용심화 마스터</span>하더니<br/>
      <b>2학년 첫 중간고사 95점!</b>
    </div>,
  },
  {
    ...
    description: <div>
      ...
      <span className="highlight">3개월만에 몇년치 복습</span>하고<br/>
      <b>3학년 첫 중간고사 70점!</b>
    </div>,
  },
  {
    ...
    description: <div>
      4개월 만에 45점 상승<br/>
      <span className="highlight">첫 중간고사에서 <b>93점</b> 달성</span><br/>

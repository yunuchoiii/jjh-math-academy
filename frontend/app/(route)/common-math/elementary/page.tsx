...
const improvedGradesList = [
  {
    ...
    student: "상곡초 6학년 A양",
    description: <div>
      <span className="highlight"><b>‘레테 LOW’</b> 수준에서 <b>‘최상위 쎈’</b>까지 도달</span><br/>
      현재 중등 과정 선행 중<br/>
  ...
  },
  {
    ...
    description: <div>
      ...
      <span className="highlight">심화 수학과 중등 수학 병행</span>하며 안정적인 성장 중!
    </div>,
  },
  {
    id: 3,
    ...
    description: <div>
      ...
      <span className="highlight">고학년 사고력 수학과 중등 선행</span> 완료 예정!
    </div>,
  },
  {
    id: 4,
    ...
    description: <div>
      ...
      <span className="highlight">현재 초등 6학년 <b>최상위 문제 풀이까지 가능!</b></span>
    </div>,
  },
  {
    id: 5,
    ...
    description: <div>
      ...
      <span className="highlight">교구와 시각 자료</span>를 활용한 학습하여<br/>

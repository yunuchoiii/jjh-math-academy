...
const improvedGradesList = [
  {
    id: 1,
    student: "상곡초 6학년 A양",
    description: `<div>‘레테 LOW’ 수준에서 ‘최상위 쎈’까지 도달<br/>
    현재 중등 과정 선행 중<br/>
    <b>고등 대비 심화 학습까지 진행!</b></div>`,
  },
  {
    id: 2,
    student: "청원초 6학년 B군",
    description: `<div>초등 3학년부터 꾸준히 학습<br/>
    <b>수탐대회 100점 및 경시대회 금상 수상</b><br/>
    심화 수학과 중등 수학 병행하며 안정적인 성장 중!</div>`,
  },
  {
    id: 3,
    student: "상계초 6학년 C군",
    description: `<div>등록 <b>6개월</b> 만에 <b>초등 5학년 후행 학습 완성</b><br/>
    <b>초등 6학년 심화</b> 진도 완료<br/>
    고학년 사고력 수학과 중등 선행 완료 예정!</div>`,
  },
  {
    id: 4,
    student: "중계초 5학년 D양",
    description: `<div>사고력과 연산이 약했던 학생,<br/>
    <b>학습 습관을 개선</b>하여 1년간 연산과 교과 과정을 병행<br/>
    현재 초등 6학년 <b>최상위 문제 풀이까지 가능!</b></div>`,
  },
  {
    id: 5,
    student: "상수초 3학년 E군",
    description: `<div>연산이 느리고 개념 이해가 부족했던 학생,<br/>
    <b>교구와 시각 자료</b>를 활용한 학습하여<br/>
    학기 중반에 교과 연산 100문제 테스트에서 <b>만점 기록!</b></div>`,
  },
];
